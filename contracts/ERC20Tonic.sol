...
contract ERC20Tonic is Tonic, IFuckingKIP7Receiver {
  using SafeERC20 for IERC20;
  IERC20 public token;

  function onKIP7Received(address _operator, address _from, uint256 _amount, bytes memory _data) external pure returns (bytes4) {
    return 0x9d188c22;
  }
